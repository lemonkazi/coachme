        ...
        <div class="col-12">
          <div class="card card-primary">
              ...
              foreach ($result as $key => $value) {
                ...
                if (!empty($data['language']->$key)) {
                    if (!empty($result[$key]['is_date_format'])) {
                      ...
                      $result[$key]['text'] = "<img style='max-width:80px;' src='{$BASE_URL}/photo/language_photo/{$data['language']->$key}' />";
                    } else {
            ...
            <div class="card-footer text-center">
                ...
                <a class="col-sm-2 btn bg-gradient-primary btn-sm text-center" href="<?php echo $BASE_URL . '/language/edit/' . $data['language']->id ?>"><?php echo trans('global.LABEL_UPDATE') ?></a>
