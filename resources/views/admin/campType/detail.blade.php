        ...
        <div class="col-12">
          <div class="card card-primary">
            ...
            <div class="card-footer text-center">
                ...
                <a class="col-sm-2 btn bg-gradient-primary btn-sm text-center" href="<?php echo $BASE_URL . '/campType/edit/' . $data['campType']->id ?>"><?php echo trans('global.LABEL_UPDATE') ?></a>
