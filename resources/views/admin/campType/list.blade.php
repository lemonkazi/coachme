                  ...
                  <form method="get" enctype="multipart/form-data" accept-charset="utf-8" class="form-table" id="dataForm" autocomplete="off" action="{{ $CURRENT_URL }}">
                    <div class="form-group button-group result-top">
                      <div class="result-top-buttons">
                        <div class="form-group">
                          <a href="{{ url('/campType/add')}}" class="btn btn-primary btn-addnew">Add New</a> 
                        </div>
                      </div>
                        ...
                        <tbody>
                          @foreach($data['campTypes'] as $campType)
                            <tr>
                              ...
                              <td> 
                                <div class="btn-group">
                                  <a href="{{url('campTypes').'/'.$campType->id}}" class="btn btn-primary">
                                    <i class="fas fa-eye"></i>
                                  </a>
                                  <a href="<?php echo $BASE_URL . '/campType/edit/' . $campType->id ?>" class="btn btn-warning" title="Edit">
