          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              foreach ($result as $key => $value) {
                if (!isset($data['experience']->$key)) {
                    continue;
                }
                if (!empty($data['experience']->$key)) {
                    if (!empty($result[$key]['is_date_format'])) {
                        $result[$key]['text'] = date('Y年m月d日', $data['experience']->$key);
                    } elseif (!empty($result[$key]['is_array'])) {
                        $result[$key]['text'] = implode (", ", $data['experience']->$key);
            ...
            <div class="card-footer text-center">
                ...
                <a class="col-sm-2 btn bg-gradient-primary btn-sm text-center" href="<?php echo $BASE_URL . '/experience/edit/' . $data['experience']->id ?>"><?php echo trans('global.LABEL_UPDATE') ?></a>
