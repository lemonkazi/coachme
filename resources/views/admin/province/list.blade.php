            ...
            <div class="card">
              ...
              <div class="table-responsive p-0">
                  ...
                  <form method="get" enctype="multipart/form-data" accept-charset="utf-8" class="form-table" id="dataForm" autocomplete="off" action="{{ $CURRENT_URL }}">
                    <div class="form-group button-group result-top">
                      <div class="result-top-buttons">
                        <div class="form-group">
                          <a href="{{ url('/province/add')}}" class="btn btn-primary btn-addnew">Add New</a> 
                        </div>
                      </div>
                        ...
                        <tbody>
                          @foreach($data['provinces'] as $province)
                            <tr>
                              ...
                              <td> 
                                <div class="btn-group">
                                  <a href="{{url('provinces').'/'.$province->id}}" class="btn btn-primary">
                                    <i class="fas fa-eye"></i>
                                  </a>
                                  <a href="<?php echo $BASE_URL . '/province/edit/' . $province->id ?>" class="btn btn-warning" title="Edit">
                                    <i class="fas fa-edit"></i>
                                  </a> 
                                  <a href="javascript:;" data-id="{{$province->id}}" class="btn btn-danger btn_delete" data-toggle="tooltip" title="Delete">
                ...
                <div class="dataTables_paginate paging_bootstrap fr">
                  ...
                  {{ $data['provinces']->links('pagination.default') }}
                </div>
              </div>
              <!-- /.card-body -->
            </div>
