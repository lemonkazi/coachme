            ...
            <div class="col-md-8">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <!-- form start -->
                  <form action="{{!empty($data['province']) ? route('province.update',[$data['province']->id]): route('province.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="name">Name <span class="input-required">*</span></label>
                          <input type="text" class="form-control" id="name" name="name" placeholder="Full Name"  value="{{!empty($data['province']) ? old('name', $data['province']->name) : old('name')}}" required>
                        </div>
                      </div>
